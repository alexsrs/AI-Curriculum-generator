...
export async function generatePDF(curriculumData: CurriculumData): Promise<Buffer> {
  let browser = null
  ...
  try {
    ...
    const cacheKey = generateCacheKey(curriculumData)
    ...
    if (!html) {
      ...
      html = generateDynamicHTML(curriculumData)
